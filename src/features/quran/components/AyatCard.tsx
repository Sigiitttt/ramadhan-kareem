    ...
    return (
        ...
        >
            ...
            <div className="text-right pt-2 pb-7 relative z-10">
                <p
                    className="text-[28px] md:text-[26px] leading-[2.3] font-normal text-gray-800 dark:text-gray-100 drop-shadow-sm selection:bg-emerald-200 dark:selection:bg-emerald-900/60"
                    dir="rtl"
