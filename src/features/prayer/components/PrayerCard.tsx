    ...
    return (
        <div className="flex flex-col gap-1.5 py-1">
            {urutan.map((kunci) => {
                ...
                // API Aladhan mengembalikan "04:15 (+07)". Kita potong spasi dan ambil index [0] agar sisa "04:15" saja.
                const jamBersih = jadwal[kunci] ? jadwal[kunci].split(' ')[0] : '--:--';

                return (
                    <div
                        key={kunci}
                        className={`group relative flex justify-between items-center px-3 py-3.5 md:p-4 rounded-[1.5rem] transition-all duration-500 overflow-hidden ${
                            adalahBerikutnya
                    ...
                    >
                        ...
                        <div className="flex items-center gap-4 pl-3">
                            <div className={`w-11 h-11 rounded-[14px] flex items-center justify-center transition-all duration-500 group-hover:scale-110 group-hover:rotate-3 ${
                                adalahBerikutnya
                        ...
                        {/* Kanan: Jam Sholat (Sudah Dibersihkan) */}
                        <div className="pr-3 text-right">
                            <span className={`text-xl md:text-2xl tabular-nums tracking-tight ${
                                adalahBerikutnya
